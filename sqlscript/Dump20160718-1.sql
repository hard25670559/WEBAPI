...
CREATE TABLE `Account_Data` (
  ...
  `Account_UserId` varchar(10) DEFAULT NULL COMMENT '帳號擁有者編號',
  ...
  `Account_Status` varchar(5) NOT NULL DEFAULT 'Using' COMMENT '帳戶狀態(停用、使用中)',
  PRIMARY KEY (`Account_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='帳號資料';
...
INSERT INTO `Account_Data` VALUES (1,NULL,'test','test','2016-07-18 14:08:12',NULL,'Using');
...
CREATE TABLE `Client_Data` (
  ...
  `Client_Account` varchar(45) NOT NULL COMMENT '客戶帳號',
  `Client_Password` varchar(45) NOT NULL COMMENT '客戶密碼',
  `Client_Create` datetime NOT NULL COMMENT '客戶資料建立日期',
  `Client_Update` datetime NOT NULL COMMENT '客戶資料修改日期',
...
CREATE TABLE `Driver_Data` (
  ...
  `Driver_ Lic` varchar(45) NOT NULL COMMENT '司機駕照',
...
CREATE TABLE `Office_Data` (
  ...
  `Office_Status` varchar(5) NOT NULL COMMENT '行政人員狀態(在職、離職)',
...
CREATE TABLE `OrderDetails_data` (
  `OrderDetails_Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '訂單詳細資料編號',
  `OrderDetails_OrderId` int(11) NOT NULL COMMENT '訂單詳細資料所屬訂單編號',
  `OrderDetails_ClientID` int(11) NOT NULL COMMENT '訂單詳細資料所屬客戶編號',
...
-- Dump completed on 2016-07-18 14:30:49
